...
public class ValidationSerializerTest {
    ...
    public void shouldSerializeAsValidZnodeName() {
        ...
        Assert.assertEquals("test_apiKey.stream_test.%5B%7B%22tag%22%3A%22tag%22%2C%22condition%22%3A%7B%22type%22%3A%22exist%22%7D%7D%5D", znode);
    ...
    public void shouldDeserializeCorrectly() {
        ValidationSerializer validationSerializer = new ValidationSerializer();
        String value = "test_apiKey.stream_test.%5B%7B%22tag%22%3A%22tag%22%2C%22condition%22%3A%7B%22type%22%3A%22exist%22%7D%7D%5D";
        ...
        Assert.assertEquals("tag", filter.getTag());
