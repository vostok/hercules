...
public class ZnodeValidator {
     ...
     * - The following characters can't be used because they don't display well, or render in confusing ways: u0001 - u0019 and u007F - u009F.<br>
     * - The following characters are not allowed: ud800 - uF8FF, uFFF0 - uFFFF.                                    <br>
     * <p>
     * Following restrictions are not checked:                                                                      <br>
     * - The "." character can be used as part of another name, but "." and ".." cannot alone be used to indicate a node along a path, because ZooKeeper doesn't use relative paths.
