...
public class GraphiteSink {
    ...
    private static final String ID_PREFIX = "hercules.sink.graphite.";

    private final KafkaStreams kafkaStreams;

    public GraphiteSink(Stream stream, Properties streamsProperties, GraphiteEventSender eventSender) {
