...
public class SentryClientHolderTest {
    ...
    private SentryConnectorHolderImplV9 sentryConnectorHolderImplV9;

    @Before
    public void init() {
        sentrySimulator = new HashMap<>();
        sentryApiClientMock = Mockito.mock(SentryApiClient.class);
        sentryConnectorHolderImplV9 = new SentryConnectorHolderImplV9(sentryApiClientMock, new Properties());
    }
    ...
    public void shouldGetClient() {
        ...
        sentryConnectorHolderImplV9.update();

        Result<SentryConnectorImplV9, ErrorInfo> sentryClient = sentryConnectorHolderImplV9.getOrCreateConnector(MY_ORGANIZATION, MY_PROJECT);
    ...
    public void shouldNotGetClientIfNameIsInvalid() {
        ...
        Result<SentryConnectorImplV9, ErrorInfo> sentryClient = sentryConnectorHolderImplV9.getOrCreateConnector("my_Company", MY_PROJECT);//capital letter
    ...
    public void shouldCreateNewOrganizationTeamAndProject() {
        ...
        Result<SentryConnectorImplV9, ErrorInfo> sentryClient = sentryConnectorHolderImplV9.getOrCreateConnector(NEW_ORGANIZATION, NEW_PROJECT);
    ...
    public void shouldCreateNewTeamAndProject() {
        ...
        Result<SentryConnectorImplV9, ErrorInfo> sentryClient = sentryConnectorHolderImplV9.getOrCreateConnector(MY_ORGANIZATION, NEW_PROJECT);
    ...
    public void shouldPullExistingOrgFromSentryToCache() {
        ...
        Result<SentryConnectorImplV9, ErrorInfo> sentryClient = sentryConnectorHolderImplV9.getOrCreateConnector(otherOrganization, NEW_PROJECT);
    ...
    public void shouldReturnErrorIfClientWasRemoved() {
        ...
        sentryConnectorHolderImplV9.update();
        sentryConnectorHolderImplV9.removeClientFromCache(SentryDestination.of(MY_ORGANIZATION, MY_PROJECT));
        Result<SentryConnectorImplV9, ErrorInfo> sentryClient = sentryConnectorHolderImplV9.getOrCreateConnector(MY_ORGANIZATION, MY_PROJECT);
