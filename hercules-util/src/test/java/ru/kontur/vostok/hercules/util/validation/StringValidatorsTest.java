...
public class StringValidatorsTest {
    ...
    public void shouldValidateMatchesWithPattern() {
        ...
        assertEquals("String should match the pattern but was 'a b'", validator.validate("a b").get());
        assertEquals("String should match the pattern but was ''", validator.validate("").get());
        assertEquals("String should match the pattern but was 'this_testing_string_contains_forty_nine_symbols__'",
